  ...
  static criarNovoHabito() {
    ...
    botaoCriar.addEventListener("click", (e) => {
      ...
      botaoInserir.addEventListener("click", (e) => {
        ...
        novoHabito.habit_category == "💜 Saúde"
          ? (novoHabito.habit_category = "saude")
          : novoHabito.habit_category == "✏️ Estudo"
          ? (novoHabito.habit_category = "estudos")
          : novoHabito.habit_category == "🏠 Casa"
          ? (novoHabito.habit_category = "casa")
          : novoHabito.habit_category == "💼 Trabalho"
          ? (novoHabito.habit_category = "trabalho")
          : novoHabito.habit_category == "⛵ Lazer"
          ? (novoHabito.habit_category = "lazer")
