...
export default class RenderModalDelete {
  static criarModalDelete(id_habito) {
    ...
    pModalDeleteParagrafo.innerText =
    ...
    divModalDeleteButao.append(
      divModalDeleteButaoCancelar,
      divModalDeleteButaoExcluir
    );
    ...
    divModalInner.append(
      divModalCabecalho,
      divModalDeleteContent,
      divModalDeleteButao
    );
