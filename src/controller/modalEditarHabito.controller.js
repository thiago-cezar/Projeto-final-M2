...
export default class RenderModal {
  ...
  static fechaModal(id_habito) {
    ...
    const btnCancelar = document.querySelector(
      ".modal__editarHabito__butao__cancelar"
    );
  ...
  static salvarDados() {
    ...
    const titulo = document.querySelector(
      ".modal__editarHabito__conteudo__inputTitulo"
    );
    const descricao = document.querySelector(
      ".modal__editarHabito__conteudo__inputTDescricao"
    );
    const categoria = document.querySelector(
      ".modal__editarHabito__conteudo__select"
    );
    const btnSalvar = document.querySelector(
      ".modal__editarHabito__butao__salvarAlteracoes"
    );
    ...
    btnSalvar.addEventListener("click", (event) => {
      ...
      if (dadosFormatados.habit_title !== "") {
        dadosFormatados.habit_category == "💜 Saúde"
          ? (dadosFormatados.habit_category = "saude")
          : dadosFormatados.habit_category == "✏️ Estudo"
          ? (dadosFormatados.habit_category = "estudos")
          : dadosFormatados.habit_category == "🏠 Casa"
          ? (dadosFormatados.habit_category = "casa")
          : dadosFormatados.habit_category == "💼 Trabalho"
          ? (dadosFormatados.habit_category = "trabalho")
          : dadosFormatados.habit_category == "⛵ Lazer"
          ? (dadosFormatados.habit_category = "lazer")
          : console.log();
